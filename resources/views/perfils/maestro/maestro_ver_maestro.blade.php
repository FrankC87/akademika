...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item" aria-current="page"><a href="{{route('maestro_lista_maestros')}}">Lista Maestros</a></li>
    ...
    <div class="container perfil_contenido py-2 px-3">
        ...
        <div class="table-responsive-md">
            <table class="table">
                ...
                <tbody id="cuerpoTemas">
                    ...
                    <tr  class='clickable_row' data-href="#" data-toggle="tooltip" data-placement="bottom" title="Articulo">
        ...
        <div class="card mb-2 my-2 card_info">
            <div class="card-body">
                ...
                <p class="card-text">El maestro no ha creado ninguna colección</p>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody id="cuerpoColecciones">
                    @foreach ($maestro->colecciones->sortByDesc('likes')->take(5) as $coleccion)
                    <tr  class='clickable_row' data-href="#" data-toggle="tooltip" data-placement="bottom" title="Coleccion">
                        <td ><i class="fas fa-archive"></i></td>
                        <td class="font-weight-bold">{{$coleccion->titulo}}</br><span class="text-muted">Creado el {{$coleccion->created_at->format('d-m-Y')}} a las {{$coleccion->created_at->format('h:m:s')}}</span></td>
                    </tr>
