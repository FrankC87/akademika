...
<div class="row cabecera_secundaria">
		...
		@if(Auth::user()->maestro->notificaciones->isEmpty())
        ...
        <div class="table-responsive">
            <table id="tablaNotificaciones" class="table order-column" style="width:100%">
                ...
                <tbody id="body_tabla">
                    @foreach (Auth::user()->maestro->notificaciones as $mensaje)
					@if($mensaje->leido)
                    <tr  class='clickable_row' data-href="{{route('maestro_ver_notificacion',$mensaje->id)}}" data-toggle="tooltip" data-placement="bottom" title="Ver mensaje">
					@else
					<tr  class='clickable_row' data-href="{{route('maestro_ver_notificacion',$mensaje->id)}}" data-toggle="tooltip" style="background-color:#d3d0cb;" data-placement="bottom" title="Ver mensaje">
					@endif
