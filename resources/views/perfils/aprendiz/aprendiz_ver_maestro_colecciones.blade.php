...
<nav aria-label="breadcrumb">
   <ol class="breadcrumb">
	...
	<li class="breadcrumb-item" aria-current="page"><a href="{{route('aprendiz_ver_maestro',$maestro->id)}}">Maestro: {{ $maestro->nick_m }}</a></li>
	<li class="breadcrumb-item active" aria-current="page"><a href="{{route('aprendiz_ver_maestro_colecciones',$maestro->id)}}">Colecciones de {{ $maestro->nick_m }}</a></li>
  </ol>
</nav>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody id="cuerpoColecciones">
                    @foreach ($maestro->colecciones->sortByDesc('likes') as $coleccion)
