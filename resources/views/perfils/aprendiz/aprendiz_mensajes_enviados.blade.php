...
@section('cuerpo_mensajes')
		...
		@if(Auth::user()->aprendiz->mensajesEnviados->isEmpty())
        ...
        <div >
              <table id="tablaMensajes" class="table order-column" style="width:100%">
                ...
                <tbody id="body_tabla">
                    @foreach (Auth::user()->aprendiz->mensajesEnviados as $mensaje)
					
					<tr  class='clickable_row' data-href="{{route('aprendiz_ver_enviado',$mensaje->id)}}" data-toggle="tooltip" data-placement="bottom" title="Ver mensaje">
