...
<form method='post' action="{{route('mensaje_enviar')}}">
    ...
    <div class="form-group">
        <input type="text" name="emisor_a" class="form-control" id="emisor_a" aria-describedby="emisor_a" value="{{Auth::user()->aprendiz->id}}" hidden>
    </div>
	<div class="form-group">
        <input type="text" name="emisor_m" class="form-control" id="emisor_m" aria-describedby="emisor_m" value="" hidden>
    </div>
    <div class="form-group">
