...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page"><a href="{{route('aprendiz_ver_maestro_temas',$maestro->id)}}">Articulos de {{ $maestro->nick_m }}</a></li>
  </ol>
</nav>
        ...
        <div class="table-responsive-md">
            <table class="table">
                ...
                <tbody id="cuerpoTemas">
                    @foreach ($maestro->temas->sortByDesc('likes') as $tema)
