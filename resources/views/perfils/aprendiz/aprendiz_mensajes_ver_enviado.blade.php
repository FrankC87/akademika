           ...
           <table id="tablaVerMensajes" class="table table-bordered" style="width:100%">
                ...
                <tbody id="body_tabla">
                    ...
                    <tr data-toggle="tooltip" data-placement="bottom" title="Destinatario">
						<td class="cabecera_tabla_mensaje font-weight-bold">DESTINATARIO</td>
						@if($mensaje->receptor_m==null)
                        <td class="font-weight-bold font-weight-bold">Aprendiz: {{$mensaje->receptorAprendiz->nick_a}}</td>
						@else
						<td class="font-weight-bold font-weight-bold">Maestro: {{$mensaje->receptorMaestro->nick_m}}</td>
						@endif			
                    </tr>
